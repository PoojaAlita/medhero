                ...
                <ul class="nav-list">
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="#" id="profileDropdown" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <img class="wd-30 ht-30 rounded-circle" src="{{profile_image() ? asset('assets/images/profileImage/'.profile_image()->profile_image) : (Auth::user()->cover_image ? asset('assets/images/CoverImage/'.Auth::user()->cover_image) :asset('assets/images/default.png'))}}" alt="">
                        </a>
                        <div class="dropdown-menu p-0" aria-labelledby="profileDropdown">
                            <div class="d-flex flex-column align-items-center border-bottom px-5 py-3">
                            <div class="mb-3">
                                {{-- @if (Auth::user()->cover_image)  --}}
                                <img class="wd-80 ht-80 rounded-circle" src="{{profile_image() ? asset('assets/images/profileImage/'.profile_image()->profile_image) : (Auth::user()->cover_image ? asset('assets/images/CoverImage/'.Auth::user()->cover_image) :asset('assets/images/default.png'))}}" alt="">
{{-- 
                                <img class="wd-80 ht-80 rounded-circle" src="{{Auth::user()->cover_image ? asset('assets/images/profileImage/'.profile_image()->profile_image) : asset('assets/images/default.png')}}" alt="">
                                @else
                                <img class="wd-80 ht-80 rounded-circle" src="{{profile_image() ? asset('assets/images/profileImage/'.profile_image()->profile_image) : asset('assets/images/default.png')}}" alt="">
                                @endif --}}
